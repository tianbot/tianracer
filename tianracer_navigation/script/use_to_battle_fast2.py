...
if __name__ == '__main__': 
  try:
    rospy.init_node("wall_following2")
    ...
    scan_pub = rospy.Publisher('front_scan_02', LaserScan, queue_size=10)
    marker_pub = rospy.Publisher('arrow_marker_02', Marker, queue_size=1)
