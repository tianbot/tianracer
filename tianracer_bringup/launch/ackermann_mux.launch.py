...
def generate_launch_description():
    ...
    default_config_locks = os.path.join(get_package_share_directory('tianracer_bringup'),
                                        'param', 'ackermann_mux_locks.yaml')
    default_config_topics = os.path.join(get_package_share_directory('tianracer_bringup'),
                                         'param', 'ackermann_mux_topics.yaml')
    default_config_joystick = os.path.join(get_package_share_directory('tianracer_bringup'),
                                           'param', 'joystick.yaml')
